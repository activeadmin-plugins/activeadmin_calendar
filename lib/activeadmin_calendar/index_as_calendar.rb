...
module ActiveAdmin
  module Views
    ...
    class IndexAsCalendar < ActiveAdmin::Component
      ...
      def header
        case @page_presenter[:header]
        when Proc   then @page_presenter[:header].call(@collection, current_month)
        when String then @page_presenter[:header]
        else             ""
        end
      end
      ...
      def build_navigation
        ...
        title = header
        text_node title if title.present?
